...
GOBUILD=CGO_ENABLED=0 go build -tags with_gvisor -trimpath -ldflags '-X "github.com/qauzy/netat/constant.Version=$(VERSION)" \
		-X "github.com/qauzy/netat/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
