...
GOBUILD=CGO_ENABLED=0 go build -tags with_gvisor -trimpath -ldflags '-X "github.com/qauzy/aiat/constant.Version=$(VERSION)" \
		-X "github.com/qauzy/aiat/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
